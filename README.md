# Lingeshwaran M — Data & AI Engineer
 
> Designing data pipelines and intelligent systems that transform raw data into reliable, production-ready assets.
 
Data & AI Infrastructure Engineer. I specialize in building robust ETL/ELT pipelines, designing optimized relational data models, and developing document intelligence systems using advanced RAG architectures. My work spans the entire data lifecycle — from raw data ingestion and schema-aware transformation to high-performance vector indexing. Open to Data Engineering / Platform Engineering internships and entry-level roles. **Open to relocation (Chennai / Bangalore / Remote).**
...
| **Databases & Spatial Storage** | PostgreSQL · MySQL · PostGIS |
| **Data Engineering** | ETL/ELT Pipelines · Data Modeling · Data Transformation · Data Ingestion · Data Quality & Validation · SQL Optimization · Batch Processing · Vector Indexing |
| **Developer Tools** | Git · Linux · VS Code · Postman |
 
### Used in Projects
`FastAPI` · `Flask` · `Streamlit` · `Next.js` · `PyTorch` · `Ollama`
 
### Learning in Practice *(Building local sandboxes)*
`Apache Airflow` · `dbt (Data Build Tool)` · `Apache Spark` · `BigQuery`
